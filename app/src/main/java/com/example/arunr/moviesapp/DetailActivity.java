...
import com.example.arunr.moviesapp.adapter.TrailerAdapter;
...
import com.example.arunr.moviesapp.model.TrailerResponse;
...
public class DetailActivity extends AppCompatActivity {
    ...
    private void loadJSON() {
        ...
        try {
            ...
            Call<TrailerResponse> call = apiService.getMovieTrailer(movie_id, BuildConfig.THE_MOVIE_API_TOKEN);
